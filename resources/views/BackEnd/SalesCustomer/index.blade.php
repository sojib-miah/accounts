...
@section('content')
    <div class="p-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h4 class="mb-0">Customer Company</h4>
                <small class="text-muted">Manage customer companies</small>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editCompany', function() {
                ...
                $('#customerCompanyModal')
                    .modal('show');
                $.ajax({
                    url: "{{ url('admin/customer-company') }}/" +
                        id,
                    type: 'GET',
            ...
            $('#customerCompanyForm').on(
                ...
                function(e) {
                    ...
                    let url = editMode ?
                        "{{ url('admin/customer-company') }}/" + id :
                        "{{ route('customer-company.store') }}";
