...
class PackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validateWithBag('add', [
            ...
            'payment_type_limit' => 'required|integer|min:-1',
            'category_limit' => 'required|integer|min:-1',
            'item_list_limit' => 'required|integer|min:-1',
            'sales_order_limit' => 'required|integer|min:-1',
        ...
        Package::create([
            ...
            'payment_type_limit' => $request->payment_type_limit,
            'category_limit' => $request->category_limit,
            'item_list_limit' => $request->item_list_limit,
